...
import cn.tengfeistudio.forum.module.post.postcontent.main.ImageActivity;
import cn.tengfeistudio.forum.utils.toast.ImageLoaderUtil;
...
public class NineGridTestLayout extends NineGridLayout {
    ...
    protected void onClickImage(int i, String url, List<String> urlList) {
        // Toast.makeText(mContext, "点击了第"+i+"张图片" + url, Toast.LENGTH_SHORT).show();
