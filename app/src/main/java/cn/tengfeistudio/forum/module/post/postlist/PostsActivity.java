package cn.tengfeistudio.forum.module.post.postlist;
...
import cn.tengfeistudio.forum.adapter.PostAdapter;
...
public class PostsActivity extends BaseActivity
     ...
     * 帖子列表
     */
    private List<TopicBean> postList = new ArrayList<>();
    /**
     * 获取最大帖子页面
     */
    private int max_page = Constants.DEFAULT_PAGE_NUMBER;
    /**
     * Panel Fragment管理器
     */
...
//    private List<PostFragment> fragmentPool;
    ...
    protected void initData() {
        ...
        getPostListData(Constants.DEFAULT_PAGE_NUMBER);
    }
    ...
    private void doRefresh() {
        ...
        adapter = null;
        getPostListData(Constants.DEFAULT_PAGE_NUMBER);
        max_page = Constants.DEFAULT_PAGE_NUMBER;
    }
    ...
    private void getPostListData(int page) {
        Observable.create((ObservableOnSubscribe<String>) emitter -> {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse(NetConfig.BASE_ALL_TOPIC).newBuilder();
            urlBuilder.addQueryParameter("theme", currentCategory);
    ...
    private void initPostListData(String JsonDataArray) {
        ...
        // 尾页处理
        printLog("专区 currentPage:" + jsonObject.getInteger("number") + " last: " + jsonObject.getBoolean("last"));
        ...
        for (int i = 0; i < array.size(); i++) {
            postList.add(JSON.parseObject(array.getString(i), TopicBean.class));
        }
...
//        fragmentPool = new ArrayList<>();
        ...
        adapter = new TopicAdapter(this, postList);
        // 设置监听事件
