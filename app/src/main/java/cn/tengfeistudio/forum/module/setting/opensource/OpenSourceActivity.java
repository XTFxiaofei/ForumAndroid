package cn.tengfeistudio.forum.module.setting.opensource;
...
public class OpenSourceActivity extends BaseActivity {
    ...
    protected void initData() {
        String content = "**# 一切伟大的行动和思想**  \n**都有一个微不足道的开始**\n" +
                ...
                "### Slidr\n" +
                "> Easily add slide-to-dismiss functionality to your ActivityBean by calling Slidr.attach(this) in your onCreate(..) method.  \n" +
