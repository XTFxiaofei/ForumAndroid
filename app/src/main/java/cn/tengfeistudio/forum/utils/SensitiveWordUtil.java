...
public class SensitiveWordUtil {
    //	private static Log log = LogFactory.getLog(SensitiveWordUtil.class);
    public static SensitiveWordUtil sensitiveWordUtil;
    private static String CHARSET = "ISO-8859-1";
    static {
        try {
//			log.debug("Instantiating SensitiveWordUtil....");
            sensitiveWordUtil = new SensitiveWordUtil();
            String[] strs=SensitiveWord.sensitiveWord.split("\\n");
            for(String str:strs){
                sensitiveWordUtil.addFilterKeyWord(str,1);
            }
            //敏感词库
...
//                sensitiveWordUtil.addFilterKeyWord(line, 1);
//            }
//            reader.close();
//            in.close();
        } catch (Exception e) {
...
//            String str = "你好 cao你大爷毛民航局FUCK5l玩引导员最牛公安fuck yout";
